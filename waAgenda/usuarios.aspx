...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSourceUsuarios" DataKeyNames="id" InsertItemPosition="LastItem">
...
<asp:SqlDataSource ID="SqlDataSourceUsuarios" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [usuario] WHERE [id] = @id" InsertCommand="INSERT INTO [usuario] ([nome], [email], [senha]) VALUES (@nome, @email, @senha)" SelectCommand="SELECT [id], [nome], [email], [senha] FROM [usuario]" UpdateCommand="UPDATE [usuario] SET [nome] = @nome, [email] = @email, [senha] = @senha WHERE [id] = @id" OnInserted="SqlDataSourceUsuarios_Inserted" OnUpdated="SqlDataSourceUsuarios_Updated" OnUpdating="SqlDataSourceUsuarios_Updating">
    <DeleteParameters>
